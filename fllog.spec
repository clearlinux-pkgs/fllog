...
Version  : 1.2.7
Release  : 3
URL      : https://sourceforge.net/projects/fldigi/files/fllog/fllog-1.2.7.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/fllog/fllog-1.2.7.tar.gz
...
%prep
%setup -q -n fllog-1.2.7
cd %{_builddir}/fllog-1.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628175038
...
cp %{_builddir}/fllog-1.2.7/COPYING %{buildroot}/usr/share/package-licenses/fllog/b47456e2c1f38c40346ff00db976a2badf36b5e3
%make_install
